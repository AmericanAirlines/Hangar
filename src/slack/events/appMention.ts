...
export const appMention: Middleware<SlackEventMiddlewareArgs<'app_mention'>> = async ({ event, context, payload}) =>{
  ...
  app.client.chat.postMessage({
    ...
    text: "Hey there :wave: I can help your team during the hackathon! To see all of the things I can help with, simply click/tap my name and chose 'Go to App' :tada:`",
  });
