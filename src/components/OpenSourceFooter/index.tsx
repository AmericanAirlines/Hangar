    ...
    <div className='container d-flex justify-content-between align-items-center'>
      <div>
        ...
        <a href='https://github.com/AmericanAirlines/Hangar/issues/new/choose'
           target='_blank' rel='noopener noreferrer'>Suggest a feature or report a bug</a>
      </div>
      <div>
        <a href='https://github.com/AmericanAirlines/Hangar' target='_blank' rel='noopener noreferrer'>
