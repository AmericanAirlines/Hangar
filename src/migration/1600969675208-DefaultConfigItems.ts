...
export class DefaultConfigItems1600969675208 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'INSERT INTO "configuration" ("key", "value") VALUES (\'jobChatQueueActive\', \'false\') ON CONFLICT DO NOTHING',
      undefined,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query("DELETE FROM \"configuration\" WHERE key='jobChatQueueActive' AND value='false'", undefined);
  }
}
