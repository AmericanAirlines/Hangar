...
export class AddJobChatToSupportRequest1610634429473 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "support_request" ALTER COLUMN "type" TYPE "support_request_type_enum" USING "type"::"text"::"support_request_type_enum"',
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "support_request" ALTER COLUMN "type" TYPE "support_request_type_enum_old" USING "type"::"text"::"support_request_type_enum_old"',
    );
