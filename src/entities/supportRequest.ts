...
export class SupportRequest extends BaseEntity {
  constructor(slackIdId: string, name: string, type: SupportRequestType) {
    ...
    this.createdAt = (undefined as unknown) as Date; // Auto-generated by database, so this gets around TS Strict Mode
    this.updatedAt = (undefined as unknown) as Date; // Auto-generated by database, so this gets around TS Strict Mode
    this.movedToInProgressAt = undefined;
  ...
  static async getNextSupportRequest(): Promise<SupportRequest> {
    ...
    do {
      const nextRequest = await SupportRequest.findOneOrFail({ where: { status: SupportRequestStatus.Pending }, order: { createdAt: 'ASC' } });
